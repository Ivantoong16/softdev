   ...
   // Contact Form Submission
    ...
    if (contactForm && formSubmissionMessage) {
        contactForm.addEventListener('submit', function(event) {
            // IMPORTANT CHANGE: Removed event.preventDefault();
            ...
            formSubmissionMessage.classList.add('text-gray-700');

            // The form will now submit naturally to the URL specified in its action attribute.
            // Formspree will handle the redirection or display a success/error page.

            // If you later decide to handle submission via JavaScript (e.g., fetch API)
            // without a full page reload, you would re-add event.preventDefault()
            // and implement the fetch logic here.
        });
    }
